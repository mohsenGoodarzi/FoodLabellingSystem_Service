...
namespace FoodLabellingSystem_Service.Controllers.API
{
    ...
    {
        private readonly Services.Interfaces.IIngredientTypeService _ingredientTypeService;
        public IngredientTypeController(Services.Interfaces.IIngredientTypeService ingredientTypeService)
        {
        ...
        [HttpGet("GetAll")]
        public async Task<IngredientTypes> GetAll()
        {
